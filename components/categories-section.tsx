...
const allCategories: Category[] = [
  ...
  { id: "rice", name: "Rice Items", image: "/icon/rice-items.jpg" },
  { id: "chicken", name: "Chicken Main Course", image: "/icon/chicken-main-course.jpg" },
  { id: "mutton", name: "Mutton Main Course", image: "/icon/mutton-main-course.jpg" },
  { id: "tandoori", name: "Tandoori Chicken", image: "/icon/tandoori-chicken.jpg" },
  { id: "noodles", name: "Noodles", image: "/icon/noodles.jpg" },
  { id: "chineseveg", name: "Chinese Veg", image: "/icon/chinese-veg.jpg" },
  { id: "chinesenonveg", name: "Chinese Non Veg", image: "/icon/chinese-non-veg.jpg" },
  { id: "tandooribreads", name: "Tandoori Breads", image: "/icon/tandoori-bread.jpg" },
  { id: "indiansidedishes", name: "Indian Side Dishes (Veg)", image: "/icon/indian-side-dish.jpg" },
  { id: "starter", name: "Starters and Momos", image: "/icon/starter.jpg" },
  { id: "rolls", name: "Rolls and Sandwiches", image: "/icon/roll.jpg" },
